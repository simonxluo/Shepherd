    ...
    <div className="space-y-4">
      ...
      {asrModels.length > 0 ? (
        ...
        <div className="flex flex-col items-center rounded-lg border border-dashed p-8 text-center">
          ...
          <p className="text-sm font-medium">{t('asr.noModels', '没有已加载的 ASR 模型')}</p>
          <p className="text-xs text-muted-foreground mt-1">{t('asr.noModelsHint', '请先加载一个支持语音识别的模型')}</p>
          <Button
            variant="outline"
            size="sm"
            className="mt-3"
