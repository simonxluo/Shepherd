    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground">
          {t('imageGen.description', '通过文本描述生成图像')}
        </p>
      </div>
      ...
      {imageModels.length > 0 ? (
        ...
        <div className="flex flex-col items-center rounded-lg border border-dashed p-8 text-center">
          ...
          <p className="text-sm font-medium">{t('imageGen.noModels', '没有已加载的图像生成模型')}</p>
          <p className="text-xs text-muted-foreground mt-1">{t('imageGen.noModelsHint', '请先加载一个支持图像生成的模型')}</p>
          <Button
            variant="outline"
            size="sm"
            className="mt-3"
